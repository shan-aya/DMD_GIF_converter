...
class DMDConverter:
    ...
    def setup_ui(self):
        ...
        self.progress_var = tk.StringVar(value=lang_manager.get('ready', 'Prêt'))
    ...
    def apply_theme(self):
        ...
        if theme == "dark":
            ...
            style.configure('.', background='#2b2b2b', foreground='white',
                          fieldbackground='#404040', bordercolor='#404040',
                          insertcolor='white')
            ...
            style.map('TEntry', fieldbackground=[('readonly', '#404040'), ('disabled', '#404040')])
            style.map('TEntry', foreground=[('readonly', 'white'), ('disabled', '#888888')])
            
            style.configure('TSpinbox', fieldbackground='#404040', foreground='white', insertcolor='white')
            style.map('TSpinbox', fieldbackground=[('readonly', '#404040'), ('disabled', '#404040')])
            style.map('TSpinbox', foreground=[('readonly', 'white'), ('disabled', '#888888')])
            
            style.configure('TCombobox', fieldbackground='#404040', foreground='white', insertcolor='white')
            style.map('TCombobox', fieldbackground=[('readonly', '#404040'), ('disabled', '#404040')])
            style.map('TCombobox', foreground=[('readonly', 'white'), ('disabled', '#888888')])
